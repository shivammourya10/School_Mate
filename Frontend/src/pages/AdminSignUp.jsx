...
function AdminSignUp() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      setUsername(""); // Clear the input fields after submitting the form
      setPassword("");
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-4 sm:p-6 md:p-8 flex flex-col justify-between">
      ...
      <div className="max-w-md mx-auto w-full mt-8">
        <p className="text-xs text-gray-500 text-center px-4">
          By proceeding, you consent to receive emails from our team, including automated communications, from School_Mate and{" "}
          <span className="underline cursor-pointer">its affiliates</span>.
        </p>
      </div>
    </div>
  );
