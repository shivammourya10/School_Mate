...
const ViewImgGalleryPage = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md relative">
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={toBeDeletedItem.albumId && toBeDeletedItem.imageId ? imageLoading : albumLoading}
              >
                Cancel
              </button>
              <button
                ...
                disabled={toBeDeletedItem.albumId && toBeDeletedItem.imageId ? imageLoading : albumLoading}
              >
                {toBeDeletedItem.albumId && toBeDeletedItem.imageId ? imageLoading : albumLoading ? "Deleting..." : "Delete"}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md relative">
            ...
            <form onSubmit={handleUpdate}>
              ...
              >
                {albumLoading ? 'Updating...' : 'Update Album'}
              </button>
            </form>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2 w-full">
            {albumLoading ?
              <div className="w-full h-full flex justify-center items-center">
                <svg height={150} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><circle fill="none" stroke-opacity="1" stroke="#000000" stroke-width=".5" cx="100" cy="100" r="0"><animate attributeName="r" calcMode="spline" dur="2" values="1;80" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate><animate attributeName="stroke-width" calcMode="spline" dur="2" values="0;25" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate><animate attributeName="stroke-opacity" calcMode="spline" dur="2" values="1;0" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate></circle></svg>
              </div>
              :
      ...
      {(!yearLoading && !albumLoading && selectedAlbum && imageLoading) ?
        <div className="w-full h-full flex justify-center items-center">
          <svg height={150} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><circle fill="none" stroke-opacity="1" stroke="#000000" stroke-width=".5" cx="100" cy="100" r="0"><animate attributeName="r" calcMode="spline" dur="2" values="1;80" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate><animate attributeName="stroke-width" calcMode="spline" dur="2" values="0;25" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate><animate attributeName="stroke-opacity" calcMode="spline" dur="2" values="1;0" keyTimes="0;1" keySplines="0 .2 .5 1" repeatCount="indefinite"></animate></circle></svg>
        </div>
        :
