      ...
      {syllabi.length === 0 ?
        <div className="flex flex-col justify-center items-center text-xl h-full gap-y-4">
          ...
          <button
            ...
            onClick={() => { navigate('/admin-add-syllabus') }}
          >
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {syllabi.map((item) => (
              <div key={item._id} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-center items-center">
